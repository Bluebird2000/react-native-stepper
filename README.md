...
### Installation
``npm install @Bluebird2000/react-native-stepper --save``

### Usage
```javascript
import StepIndicator from '@Bluebird2000/react-native-stepper';
...
### License
 ...
 - [ISC](https://github.com/Bluebird2000/@Bluebird2000/react-native-stepper/blob/master/LICENSE).  © Bluebird2000